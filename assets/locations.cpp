...
std::vector<std::string> defaultSpiceKernels() {
    ...
    return std::vector<std::string>({MODELSPACE_DIR + slash() + "cspice" + slash() + "data" + slash() + "naif0012.tls",
                                     ...
                                     MODELSPACE_DIR + slash() + "cspice" + slash() + "data" + slash() + "earth_assoc_itrf93.tf",
                                     MODELSPACE_DIR + slash() + "cspice" + slash() + "data" + slash() + "earth_latest_high_prec.bpc",
                                     MODELSPACE_DIR + slash() + "cspice" + slash() + "data" + slash() + "earth_latest_high_prec.cmt",
                                     MODELSPACE_DIR + slash() + "cspice" + slash() + "data" + slash() + "earth_1962_240827_2124_combined.bpc",
                                     MODELSPACE_DIR + slash() + "cspice" + slash() + "data" + slash() + "earth_1962_240827_2124_combined.cmt"});
}

std::string licenseLocation() {
    return LICENSE_DIR + slash() + "licensefile.enc";
}